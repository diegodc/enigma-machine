...
/**
 * Turnover positions of the rotors.
 *
 * @author diegodc 2017-04-08.
 */
public class TurnoverPositions {

    public static final Letter[] ROTOR_I_NOTCH = {Q};
    public static final Letter[] ROTOR_II_NOTCH = {E};
